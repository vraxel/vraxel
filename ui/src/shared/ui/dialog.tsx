      ...
      >
        <div
          ...
          className={cn(
            ...
            "relative grid grid-cols-[minmax(0,1fr)] w-full max-w-[calc(100%-2rem)] gap-4 rounded-xl border border-border-subtle bg-card p-6 shadow-xl duration-150 ease-out overflow-hidden pointer-events-auto group-data-[state=open]/dialog-content:animate-in group-data-[state=open]/dialog-content:zoom-in-95 group-data-[state=closed]/dialog-content:animate-out group-data-[state=closed]/dialog-content:zoom-out-95 sm:max-w-lg",
            className
          )}
        >
          {children}
