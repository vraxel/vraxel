                    ...
                    <div className="space-y-0.5">
                      ...
                      {subsVis.map((sub) => {
                        ...
                        return (
                          ...
                          >
                            <CollapsibleTrigger className="group text-muted-foreground hover:text-sidebar-accent-foreground flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm font-semibold transition-colors">
