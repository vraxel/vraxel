...
const iam = {
  ...
  "workspace.members": "用户",
  "workspace.membersManage": "管理租户用户。共 {count} 个。",
  "workspace.owner": "所有者",
  "workspace.namespaceCount": "项目数",
  "workspace.memberCount": "用户数",
  ...
  "workspace.addMember": "添加用户",
  "workspace.addMemberDesc": "选择要添加到租户的用户。",
  "workspace.removeMember": "移除用户",
  ...
  "namespace.members": "用户",
  "namespace.membersManage": "管理项目用户。共 {count} 个。",
  "namespace.memberCount": "用户数",
  "namespace.maxMembers": "最大用户数",
  "namespace.maxMembersHint": "0 表示不限制",
  "namespace.validation.maxMembers": "必须为 0 ~ 1000000 的整数",
  ...
  "namespace.addMember": "添加用户",
  "namespace.addMemberDesc": "选择要添加到项目的用户。",
  "namespace.removeMember": "移除用户",
  ...
  "role.validation.name.format": "名称需为3-50位字母、数字、连字符或下划线",
  ...
  "rolebinding.revoke": "撤销",
  "rolebinding.revokeConfirm": '确定要撤销 "{name}" 的此角色吗？',
  "rolebinding.ownerLocked": "所有者角色不可撤销",
  ...
  "role.desc.workspace-member": "租户基础成员，用于项目级用户的租户归属",
  ...
  "perm.iam:rolebindings:deleteCollection": "批量删除角色绑定",

  // permission codes - permissions
  "perm.iam:permissions:list": "查看权限列表",

  // additional missing keys
  "perm.iam:roles:deleteCollection": "批量删除角色",
  "perm.iam:users:reset-password": "重置用户密码",
} satisfies Messages
