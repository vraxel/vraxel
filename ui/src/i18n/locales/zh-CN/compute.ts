...
const compute = {
  ...
  "compute.host.searchPlaceholder": "搜索名称 / IP / 操作系统 / 租户 / 项目",
  ...
  "compute.host.scopeWorkspace": "租户",
  "compute.host.scopeNamespace": "项目",
  "compute.host.origin": "来源",
  "compute.host.originAll": "全部来源",
  ...
  // 指标列表头的排序菜单：一列同时给出读数和容量，"按这列排"要先问哪一个
  ...
  "compute.alertRule.title": "告警规则",
  "compute.alertRule.subtitle": "对主机心跳快照做阈值判定，服务端持续评估",
  "compute.alertRule.create": "新建规则",
  "compute.alertRule.edit": "编辑规则",
  "compute.alertRule.empty": "暂无告警规则",
  "compute.alertRule.searchPlaceholder": "搜索名称或描述",
  "compute.alertRule.deleteConfirm": "确定要删除告警规则「{name}」吗？其触发中的告警会一并清除。",
  "compute.alertRule.condition": "条件",
  "compute.alertRule.metric": "指标",
  "compute.alertRule.metricAll": "全部指标",
  "compute.alertRule.op": "比较",
  "compute.alertRule.threshold": "阈值",
  "compute.alertRule.forSeconds": "持续秒数",
  "compute.alertRule.forSecondsRange": "0 到 86400 之间的整数",
  "compute.alertRule.forHint": "持续 {seconds} 秒后触发",
  "compute.alertRule.severity": "级别",
  "compute.alertRule.severityAll": "全部级别",
  "compute.alertRule.severities.info": "提示",
  "compute.alertRule.severities.warning": "警告",
  "compute.alertRule.severities.critical": "严重",
  "compute.alertRule.ops.gt": ">",
  "compute.alertRule.ops.ge": ">=",
  "compute.alertRule.ops.lt": "<",
  "compute.alertRule.ops.le": "<=",
  "compute.alertRule.metrics.cpu_used_pct": "CPU 使用率 %",
  "compute.alertRule.metrics.mem_used_pct": "内存使用率 %",
  "compute.alertRule.metrics.disk_used_pct": "磁盘使用率 %",
  "compute.alertRule.metrics.load1": "1 分钟负载",
  "compute.alertRule.metrics.load5": "5 分钟负载",
  "compute.alertRule.metrics.load15": "15 分钟负载",
  "compute.alertRule.metrics.net_rx_bps": "网络接收 B/s",
  "compute.alertRule.metrics.net_tx_bps": "网络发送 B/s",
  "compute.alertRule.enabled": "启用",
  "compute.alertRule.disabled": "已停用",
  "compute.alertRule.firing": "触发中",
  "compute.alertRule.firingBadge": "{count} 告警",
  "compute.alertRule.firingOn": "{count} 条告警触发中",
  "compute.alertRule.firedAt": "触发值 {value}",
