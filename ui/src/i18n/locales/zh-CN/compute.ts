...
const compute = {
  ...
  "compute.host.biosVersion": "BIOS 版本",
  "compute.host.serialNumber": "序列号",
  "compute.host.virt.physical": "物理机",
  ...
  "compute.host.virt.unknown": "未知虚拟化",

  "compute.host.nic.name": "网卡",
  "compute.host.nic.address": "地址",
  "compute.host.nic.mac": "MAC",
  "compute.host.nic.speed": "速率",
  "compute.host.nic.mtu": "MTU",
  "compute.host.nic.state": "状态",

  "compute.host.blockDevices": "块设备",
  "compute.host.filesystems": "文件系统",
  "compute.host.disk.name": "设备",
  "compute.host.disk.model": "型号",
  "compute.host.disk.media": "介质",
  "compute.host.disk.size": "容量",
  "compute.host.disk.hdd": "机械盘",
  "compute.host.disk.ssd": "固态盘",
  "compute.host.fs.mount": "挂载点",
  "compute.host.fs.device": "设备",
  "compute.host.fs.type": "类型",
