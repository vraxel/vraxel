const compute = {
  ...
  "compute.host.units": "systemd units",
  "compute.host.unitsBroken": "{{count}} not healthy",
  "compute.host.unitsHealthy": "All healthy",
  "compute.host.unitSearch": "Search name, state or description",
  "compute.host.unit.name": "Unit",
  "compute.host.unit.state": "State",
  "compute.host.unit.enabled": "Startup",
  "compute.host.unit.description": "Description",
