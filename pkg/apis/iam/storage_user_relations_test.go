				...
				Items: []modstore.UserWithRoleRow{
					{
						...
						Roles:    []string{modstore.RoleWorkspaceAdmin},
						JoinedAt: testTime,
					},
					{
						UserRow: modstore.UserRow{
						...
						Roles:    []string{modstore.RoleWorkspaceViewer},
						JoinedAt: testTime,
					},
				},
				TotalCount: 2,
				...
				Items: []modstore.UserWithRoleRow{
					{
						...
						Roles:    []string{modstore.RoleNamespaceAdmin},
						JoinedAt: testTime,
					},
					{
						UserRow: modstore.UserRow{
						...
						Roles:    []string{modstore.RoleNamespaceViewer},
						JoinedAt: testTime,
					},
				},
				TotalCount: 2,
