...
import (
	...
	"vraxel.io/vraxel/lib/fs/fsutil"
	"vraxel.io/vraxel/lib/logger"
	"vraxel.io/vraxel/lib/memory"
)
...
var (
	readDuration      = metrics.NewFloatCounter(`vraxel_filestream_read_duration_seconds_total`)
	readCallsBuffered = metrics.NewCounter(`vraxel_filestream_buffered_read_calls_total`)
	readCallsReal     = metrics.NewCounter(`vraxel_filestream_real_read_calls_total`)
	readBytesBuffered = metrics.NewCounter(`vraxel_filestream_buffered_read_bytes_total`)
	readBytesReal     = metrics.NewCounter(`vraxel_filestream_real_read_bytes_total`)
	readersCount      = metrics.NewCounter(`vraxel_filestream_readers`)
)
...
var (
	writeDuration        = metrics.NewFloatCounter(`vraxel_filestream_write_duration_seconds_total`)
	writeCallsBuffered   = metrics.NewCounter(`vraxel_filestream_buffered_write_calls_total`)
	writeCallsReal       = metrics.NewCounter(`vraxel_filestream_real_write_calls_total`)
	writtenBytesBuffered = metrics.NewCounter(`vraxel_filestream_buffered_written_bytes_total`)
	writtenBytesReal     = metrics.NewCounter(`vraxel_filestream_real_written_bytes_total`)
	writersCount         = metrics.NewCounter(`vraxel_filestream_writers`)
)
